...
//                     int difference=secondOrderArray[whoesTurn]->firstOrder-0+1;
//                     for (int j=0; j<N; j++) {
//                         if ((playerlist[j].firstOrder-difference)<0) {
//                             playerlist[j].firstOrder = playerlist[j].firstOrder - difference+N;
//                         }else{
//                             playerlist[j].firstOrder = playerlist[j].firstOrder - difference;
//                         }
//                     }
//                 }
//                 elem2=strtok(NULL,"+");
